...
//       setState(() {
//         fontSize = prefs.getDouble(fontSizeKey) ?? 18.0; // Default to 18.0 if not found
//       });
...
//                                 setState(() {
//                                   fontSize = value;
//                                   _saveFontSize(value); // Save font size when changed
//                                   _updateWebViewContent();
//                                 });
//                               },
//                             ),
...
//             onChanged: null,
//             activeColor: isDarkMode ? Colors.white70 : Colors.black54,
...
//             children: [
//               Text(
//                 estimatedDurationOfTTSFormatted(currentPosition),
//                 style: TextStyle(
//                   color: isDarkMode ? Colors.white : Colors.black,
//                 ),
//               ),
//               Text(
//                 estimatedDurationOfTTSFormatted(totalDuration),
//                 style: TextStyle(
//                   color: isDarkMode ? Colors.white : Colors.black,
//                 ),
//               ),
